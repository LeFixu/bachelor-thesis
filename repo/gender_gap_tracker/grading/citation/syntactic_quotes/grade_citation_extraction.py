...
from gender_gap_tracker.utils.string_similarity import get_string_similarity
from gender_gap_tracker.classes.citation import Quote
from gender_gap_tracker.grading.citation.citation_grade import (
    CitationGrade,
    ArticleGrade,
    PortalGrade,
    QuotationExtractionGrade,
)
from gender_gap_tracker.functions.get_citations_from_string import get_syntactic_quotes
